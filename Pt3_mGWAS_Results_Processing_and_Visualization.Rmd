---
title: "Integrating genomics and multiplatform metabolomics enables metabolite QTL detection in breeding-relevant apple germplasm"
author: "Emma Bilbrey"
date: "2/26/2021"
output:
  github_document:
...
Code in this markdown represents the last third of the work for our publication. This third is dedicated to mGWAS and PBA results processing and visualization. Data inputs can be found in the supplemental material for the publication.
...
Table S12 Output from metabolite genome-wide association studies (mGWAS) in the form of -log10(P) values for each single nucleotide polymorphism (SNP)-metabolomic feature combination for the analysis of liquid chromatography-mass spectrometry (LC-MS) (+) data of the Diverse population set.  NA denotes missing data.
...
Table S13 Output from metabolite genome-wide association studies (mGWAS) in the form of -log10(P) values for each single nucleotide polymorphism (SNP)-metabolomic feature combination for the analysis of liquid chromatography-mass spectrometry (LC-MS) (+) data of the Pedigree population set.  NA denotes missing data. 
...
Table S14 Output from metabolite genome-wide association studies (mGWAS) in the form of -log10(P) values for each single nucleotide polymorphism (SNP)-metabolomic feature combination for the analysis of liquid chromatography-mass spectrometry (LC-MS) (+) data of the Progeny population set. NA denotes missing data. 
...
Table S15 Output from metabolite genome-wide association studies (mGWAS) in the form of -log10(P) values for each single nucleotide polymorphism (SNP)-metabolomic feature combination for the analysis of liquid chromatography-mass spectrometry (LC-MS) (-) data of the Diverse population set. NA denotes missing data. 
...
Table S16 Output from metabolite genome-wide association studies (mGWAS) in the form of -log10(P) values for each single nucleotide polymorphism (SNP)-metabolomic feature combination for the analysis of liquid chromatography-mass spectrometry (LC-MS) (-) data of the Pedigree population set. NA denotes missing data.
...
Table S18 Output from metabolite genome-wide association studies (mGWAS) in the form of -log10(P) values for each single nucleotide polymorphism (SNP)-metabolomic feature combination for the analysis of nuclear magnetic resonance (NMR) spectroscopy data of the Diverse population set. NA denotes missing data.
...
Table S19 Output from metabolite genome-wide association studies (mGWAS) in the form of -log10(P) values for each single nucleotide polymorphism (SNP)-metabolomic feature combination for the analysis of nuclear magnetic resonance (NMR) spectroscopy data of the Pedigree population set. NA denotes missing data. 
...
Table S20 Output from metabolite genome-wide association studies (mGWAS) in the form of -log10(P) values for each single nucleotide polymorphism (SNP)-metabolomic feature combination for the analysis of NMR data of the Progeny population set. NA denotes missing data. 
